...
import { getProducts } from '../../features/maleProductsBackpacks/selectors';
...
class Backpacks extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Backpacks);