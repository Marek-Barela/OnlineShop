...
import { getProducts } from '../../features/maleProductsTrousers/selectors';
...
class Trousers extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Trousers);