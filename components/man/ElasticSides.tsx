...
import { getProducts } from '../../features/maleProductsElasticSides/selectors';
...
class ElasticSides extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(ElasticSides);