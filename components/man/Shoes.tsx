...
import { getProducts } from '../../features/maleProductsShoes/selectors';
...
class Shoes extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Shoes);