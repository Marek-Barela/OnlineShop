...
import { getProducts } from '../../features/femaleProductsWatches/selectors';
...
class Watches extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Watches);