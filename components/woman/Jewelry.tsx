...
import { getProducts } from '../../features/femaleProductsJewelry/selectors';
...
class Jewelry extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Jewelry);