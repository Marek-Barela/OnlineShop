...
import { getProducts } from '../../features/femaleProductsBallerina/selectors';
...
class Ballerina extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Ballerina);