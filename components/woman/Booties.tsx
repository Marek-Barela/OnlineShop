...
import { getProducts } from '../../features/femaleProductsBooties/selectors';
...
class Booties extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Booties);