...
import { getProducts } from '../../features/femaleProductsBags/selectors';
...
class Bags extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Bags);