...
import { getProducts } from '../../features/femaleProductsTracksuit/selectors';
...
class Tracksuit extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Tracksuit);