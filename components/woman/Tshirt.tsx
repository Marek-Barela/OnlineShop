...
import { getProducts } from '../../features/femaleProductsTshirt/selectors';
...
class Tshirt extends Component<Props> {
  render() {
...
export default connect<StateProps, {}, {}, RootState>(mapStateToProps, {})(Tshirt);